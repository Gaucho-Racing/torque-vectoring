...
int main(int argc, char*argv[]) {
    ...
    const int maxTotalIter = 100000;
    start = clock();

    
    double normalForce[4] = {350*0.2,350*0.3,350*0.2,350*0.3};
...
//    }
    ...
    while(iteration < 10000 && solve_system(d2J,dJ,newtonStep)) {
